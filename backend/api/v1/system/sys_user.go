...
type UserSearchReq struct {
	g.Meta   `path:"/system/user/list" tags:"用户管理" method:"get" summary:"用户列表"`
...
type UserGetParamsReq struct {
	g.Meta `path:"/system/user/params" tags:"用户管理" method:"get" summary:"用户维护参数获取"`
}
...
type UserAddReq struct {
	g.Meta `path:"/system/user/add" tags:"用户管理" method:"post" summary:"添加用户"`
	*SetUserReq
...
type UserEditReq struct {
	g.Meta `path:"/system/user/edit" tags:"用户管理" method:"put" summary:"修改用户"`
	*SetUserReq
...
type UserGetEditReq struct {
	g.Meta `path:"/system/user/getEdit" tags:"用户管理" method:"get" summary:"获取用户信息"`
	Id     uint64 `p:"id"`
}
...
type UserResetPwdReq struct {
	g.Meta   `path:"/system/user/resetPwd" tags:"用户管理" method:"put" summary:"重置用户密码"`
...
type UserStatusReq struct {
	g.Meta     `path:"/system/user/setStatus" tags:"用户管理" method:"put" summary:"设置用户状态"`
	Id         uint64 `p:"userId" v:"required#用户id不能为空"`
...
type UserDeleteReq struct {
	g.Meta `path:"/system/user/delete" tags:"用户管理" method:"delete" summary:"删除用户"`
...
type UserGetByIdsReq struct {
	g.Meta `path:"/system/user/getUsers" tags:"用户管理" method:"get" summary:"同时获取多个用户"`
	commonApi.Author
	Ids []int `p:"ids" v:"required#ids不能为空"`
}
