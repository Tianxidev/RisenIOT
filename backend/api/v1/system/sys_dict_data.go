...
type GetDictReq struct {
	g.Meta `path:"/system/dict/data/getDictData" tags:"字典管理" method:"get" summary:"获取字典数据公共方法"`
	commonApi.Author
...
type DictDataSearchReq struct {
	g.Meta    `path:"/system/dict/data/list" tags:"字典管理" method:"get" summary:"字典数据列表"`
...
type DictDataAddReq struct {
	g.Meta `path:"/system/dict/data/add" tags:"字典管理" method:"post" summary:"添加字典数据"`
	*DictDataReq
}
...
type DictDataGetReq struct {
	g.Meta   `path:"/system/dict/data/get" tags:"字典管理" method:"get" summary:"获取字典数据"`
...
type DictDataEditReq struct {
	g.Meta   `path:"/system/dict/data/edit" tags:"字典管理" method:"put" summary:"修改字典数据"`
...
type DictDataDeleteReq struct {
	g.Meta `path:"/system/dict/data/delete" tags:"字典管理" method:"delete" summary:"删除字典数据"`
	Ids    []int `p:"ids"`
}
