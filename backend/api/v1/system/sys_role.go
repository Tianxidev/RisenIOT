...
type RoleListReq struct {
	g.Meta   `path:"/system/role/list" tags:"角色管理" method:"get" summary:"角色列表"`
...
type RoleGetParamsReq struct {
	g.Meta `path:"/system/role/getParams" tags:"角色管理" method:"get" summary:"角色编辑参数"`
}
...
type RoleAddReq struct {
	g.Meta    `path:"/system/role/add" tags:"角色管理" method:"post" summary:"添加角色"`
...
type RoleGetReq struct {
	g.Meta `path:"/system/role/get" tags:"角色管理" method:"get" summary:"获取角色信息"`
...
type RoleEditReq struct {
	g.Meta    `path:"/system/role/edit" tags:"角色管理" method:"put" summary:"修改角色"`
...
type RoleDeleteReq struct {
	g.Meta `path:"/system/role/delete" tags:"角色管理" method:"delete" summary:"删除角色"`
