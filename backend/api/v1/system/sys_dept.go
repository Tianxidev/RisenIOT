...
type DeptSearchReq struct {
	g.Meta   `path:"/system/dept/list" tags:"部门管理" method:"get" summary:"部门列表"`
...
type DeptAddReq struct {
	g.Meta   `path:"/system/dept/add" tags:"部门管理" method:"post" summary:"添加部门"`
...
type DeptEditReq struct {
	g.Meta   `path:"/system/dept/edit" tags:"部门管理" method:"put" summary:"修改部门"`
...
type DeptDeleteReq struct {
	g.Meta `path:"/system/dept/delete" tags:"部门管理" method:"delete" summary:"删除部门"`
...
type DeptTreeSelectReq struct {
	g.Meta `path:"/system/dept/treeSelect" tags:"部门管理" method:"get" summary:"获取部门树形菜单"`
}
